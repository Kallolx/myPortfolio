    ...
    <div className="w-full lg:w-2/5 flex flex-col z-10">
      <div className="mb-10">
        <div className="mb-6">
          ...
          <h3 className="text-6xl md:text-7xl font-regular -tracking-[0.06em] text-gray-500">
            Projects Gallery
          </h3>
        </div>
      </div>
          ...
          >
            ...
            <div className="flex-1">
              ...
              `}>
                ...
                {index === activeProject && (
                  <img src="/icons/arrow.svg" alt="Web Development icon" className="w-8 h-8 object-contain -mr-9" />
                )}
              </div>
